...
/* /var/www/html/lostcar/skins/crisp_white/customer/signin/signin.twig */
class __TwigTemplate_503a050f748c9da7eabbef3c75baa721fe45e605ccee6b5056dc62d5a2ea13c0 extends \XLite\Core\Templating\Twig\Template
{
...
echo $templateWrapperStart;
        ...
        // line 9
        $this->loadTemplate("signin/parts/login.heading.twig", "/var/www/html/lostcar/skins/crisp_white/customer/signin/signin.twig", 9)->display($context);
        if ($templateWrapperText) {
...
echo $templateWrapperStart;
        ...
        // line 29
        $this->loadTemplate("signin/parts/anonymous.heading.twig", "/var/www/html/lostcar/skins/crisp_white/customer/signin/signin.twig", 29)->display($context);
        if ($templateWrapperText) {
            echo $this->getThis()->endMarker($fullPath, $templateWrapperText);
        }
        // line 30
...
";
    ...
    {
        return "/var/www/html/lostcar/skins/crisp_white/customer/signin/signin.twig";
    }
