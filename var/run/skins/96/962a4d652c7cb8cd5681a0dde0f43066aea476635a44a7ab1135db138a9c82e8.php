...
/* /var/www/html/lostcar/skins/crisp_white/customer/product/details/parts/page.tabs.twig */
class __TwigTemplate_928b9030ab84eff8b5ca2c13ed3cb007609383e2cba775ffaa81c17be68923f5 extends \XLite\Core\Templating\Twig\Template
{
...
echo $templateWrapperStart;
                    ...
                    $this->loadTemplate($this->getAttribute($context["tab"], "template", array()), "/var/www/html/lostcar/skins/crisp_white/customer/product/details/parts/page.tabs.twig", 25)->display($context);
                    if ($templateWrapperText) {
...
";
    ...
    {
        return "/var/www/html/lostcar/skins/crisp_white/customer/product/details/parts/page.tabs.twig";
    }
...
/*             <a data-id="{{ tab.id|raw }}" href="{{ url('product', '', {'product_id': this.product.productId}) }}#{{ tab.id|raw }}" data-toggle="tab">{{ tab.name }}</a>*/
/*           </li>*/
/*         {% endfor %}*/
/*       </ul>*/
/*     </div>*/
