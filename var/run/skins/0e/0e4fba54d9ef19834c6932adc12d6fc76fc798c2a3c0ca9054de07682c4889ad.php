...
/* /var/www/html/lostcar/skins/jThemesStudio_The80sMod/customer/signin/signin.twig */
class __TwigTemplate_93674495d0d4a159f13b1203495b1e62236dbffab283350f61ec7443a1170037 extends \XLite\Core\Templating\Twig\Template
{
...
echo $templateWrapperStart;
        ...
        // line 9
        $this->loadTemplate("signin/parts/login.heading.twig", "/var/www/html/lostcar/skins/jThemesStudio_The80sMod/customer/signin/signin.twig", 9)->display($context);
        if ($templateWrapperText) {
      ...
      ";
            // line 12
            echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('widget')->getCallable(), array($this->env, $context, array(0 => "XLite\\Module\\JThemesStudio\\The80sMod\\View\\CheckoutAuthorization"))), "html", null, true);
            echo "
    </div>
    ";
        } else {
...
echo $templateWrapperStart;
        ...
        // line 29
        $this->loadTemplate("signin/parts/anonymous.heading.twig", "/var/www/html/lostcar/skins/jThemesStudio_The80sMod/customer/signin/signin.twig", 29)->display($context);
        if ($templateWrapperText) {
            echo $this->getThis()->endMarker($fullPath, $templateWrapperText);
        }
        // line 30
...
";
    ...
    {
        return "/var/www/html/lostcar/skins/jThemesStudio_The80sMod/customer/signin/signin.twig";
    }
...
/*     <div class="login-box">*/
/*       {{ widget('XLite\\Module\\JThemesStudio\\The80sMod\\View\\CheckoutAuthorization') }}*/
/*     </div>*/
/*     {% else %}*/
