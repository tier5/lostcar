...
/* /var/www/html/lostcar/skins/admin/center.twig */
class __TwigTemplate_3953c3bb1a79aa1b2d4be16286d9904f8de04955352abadae64f945297a3232b extends \XLite\Core\Templating\Twig\Template
{
...
echo $templateWrapperStart;
        ...
        // line 6
        $this->loadTemplate("noscript.twig", "/var/www/html/lostcar/skins/admin/center.twig", 6)->display($context);
        if ($templateWrapperText) {
...
echo $templateWrapperStart;
            ...
            $this->loadTemplate("access_denied.twig", "/var/www/html/lostcar/skins/admin/center.twig", 19)->display($context);
            if ($templateWrapperText) {
                echo $this->getThis()->endMarker($fullPath, $templateWrapperText);
            }
        }
...
echo $templateWrapperStart;
            ...
            $this->loadTemplate("license_message.twig", "/var/www/html/lostcar/skins/admin/center.twig", 23)->display($context);
            if ($templateWrapperText) {
                echo $this->getThis()->endMarker($fullPath, $templateWrapperText);
            }
        }
...
";
    ...
    {
        return "/var/www/html/lostcar/skins/admin/center.twig";
    }
