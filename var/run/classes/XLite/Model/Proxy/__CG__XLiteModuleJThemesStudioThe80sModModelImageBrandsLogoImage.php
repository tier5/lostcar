...
namespace XLite\Model\Proxy\__CG__\XLite\Module\JThemesStudio\The80sMod\Model\Image;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class BrandsLogoImage extends \XLite\Module\JThemesStudio\The80sMod\Model\Image\BrandsLogoImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'brandsLogoItem', 'alt', 'width', 'height', 'hash', 'needProcess', 'id', 'path', 'fileName', 'mime', 'storageType', 'size', 'date', 'loadError', 'loadErrorMessage', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BrandsLogoImage $proxy) {
    ...
    public function setBrandsLogoItem(\XLite\Module\JThemesStudio\The80sMod\Model\BrandsLogoItem $brandsLogoItem = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBrandsLogoItem', array($brandsLogoItem));

        return parent::setBrandsLogoItem($brandsLogoItem);
    }
    ...
    public function getBrandsLogoItem()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBrandsLogoItem', array());

        return parent::getBrandsLogoItem();
    }
