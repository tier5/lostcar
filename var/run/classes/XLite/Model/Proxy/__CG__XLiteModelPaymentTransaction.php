...
class Transaction extends \XLite\Model\Payment\Transaction implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function isCallbackLockExpired()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isCallbackLockExpired', array());

        return parent::isCallbackLockExpired();
    }
    ...
    public function hasCallbackLock()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasCallbackLock', array());

        return parent::hasCallbackLock();
    }
    ...
    public function lockCallbackProcessing($ttl_time = 3600)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'lockCallbackProcessing', array($ttl_time));

        return parent::lockCallbackProcessing($ttl_time);
    }
    ...
    public function unlockCallbackProcessing()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'unlockCallbackProcessing', array());

        return parent::unlockCallbackProcessing();
    }
