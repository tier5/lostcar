 ...
 *
 */
 class NewArrivals extends \XLite\Module\CDev\ProductAdvisor\Module\XC\ThemeTweaker\View\NewArrivals implements \XLite\Base\IDecorator
{
    ...
    protected function isVisible()
    {
        $result = parent::isVisible()
            || 'tab_new_arrivals' == $this->viewListName
            || 'welcome.na.block' == $this->viewListName;

        if ('main' == \XLite\Core\Request::getInstance()->target
            && ($this->layout->isTabsVisible() || $this->layout->isLayoutType2() || $this->layout->isLayoutType3())
        ) {
    ...
    public function getJSFiles()
    {
        ...
        if(!\XLite::isAdminZone() && ($this->layout->isLayoutType2() || $this->layout->isLayoutType1() || $this->layout->isLayoutType3())){
            $list[] = 'js/carousel/na_half_carousel.js';
        }
