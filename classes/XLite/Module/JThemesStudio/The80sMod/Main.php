...
namespace XLite\Module\JThemesStudio\The80sMod;
...
abstract class Main extends \XLite\Module\AModuleSkin
{
    ...
    {
        return \XLite\Core\Converter::buildURL('layout_types_settings');
    }
    ...
    public static function getLayoutTypes()
    {
        ...
        return [
            ...
            Layout::LAYOUT_GROUP_HOME => Layout::getInstance()->getLayoutHomeTypes()
        ];
    }
    ...
    {
        return [
            \XLite::CUSTOMER_INTERFACE => ['jThemesStudio_The80sMod' . LC_DS . 'customer'],
            \XLite::ADMIN_INTERFACE => ['jThemesStudio_The80sMod' . LC_DS . 'admin'],
        ];
    }
    ...
    protected static function moveTemplatesInLists()
    {
        $templates = [
            ...
            'layout/header/header.bar.search.twig' => [
                ...
                static::TO_ADD => [
                    ['header.menu.block', 400, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ['welcome.header.menu.block', 400, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ],
            ...
            'product/details/stock/label.twig' => [
                ...
                static::TO_ADD => [
                    ['itemsList.product.grid.customer.info', 11, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ['itemsList.product.list.customer.info', 22, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ],
            ...
            'items_list/product/parts/common.display-modes.twig' => [
                ...
                static::TO_ADD => [
                    ['itemsList.product.grid.customer.header', 0, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ['itemsList.product.list.customer.header', 0, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ['itemsList.product.table.customer.header', 0, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ],
            ...
            'items_list/product/parts/common.product-name.twig' => [
                ...
                static::TO_ADD => [
                    ['itemsList.product.grid.customer.info', 12, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ],
            ...
            'items_list/product/parts/common.product-price.twig' => [
                ...
                static::TO_ADD => [
                    ['product.price.container', 200, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ],
            ...
            'items_list/product/parts/grid.button-add2cart-wrapper.twig' => [
                ...
                static::TO_ADD => [
                    ['itemsList.product.grid.customer.info.bcontainer', 400, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ],
            ...
            'items_list/product/parts/list.button-add2cart.twig' => [
                ...
                static::TO_ADD => [
                    ['itemsList.product.list.customer.info.bcontainer', 998, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ],
            ...
            'product/details/parts/common.price.twig' => [
                ...
                static::TO_ADD => [
                    ['product.details.page.info', 15, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ['product.details.quicklook.info', 15, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ],
        ...
        if (static::isModuleEnabled('XC\Reviews')) {
            $templates += [
                'modules/XC/Reviews/product.items_list.rating.twig' => [
                    ...
                    static::TO_ADD => [
                        ['product.price.container', 100, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                        ['reviews.recently.product', 100, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ],
                ],
        ...
        if (static::isModuleEnabled('QSL\MyWishlist')) {
            $templates += [
                ...
                'modules/QSL/MyWishlist/items_list/product/parts/common.add-button.twig' => [
                    static::TO_DELETE => [
                        ['itemsList.product.grid.customer.info', \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                        ['itemsList.product.list.customer.info', \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ],
                    static::TO_ADD    => [
                        ['itemsList.product.grid.customer.info.bcontainer', 100, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                        ['itemsList.product.list.customer.info.bcontainer', 100, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ],
                ],
            ];
        }
        ...
        if (static::isModuleEnabled('CDev\Paypal')) {
            ...
            $templates['modules/CDev/Paypal/product/details/parts/express_checkout.twig'] = [
                static::TO_DELETE => [
                    ['product.details.page.info.buttons-added.cart-buttons', \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ['product.details.quicklook.info.buttons-added.cart-buttons', \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ['product.details.page.info.buttons.cart-buttons', \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ['product.details.quicklook.info.buttons.cart-buttons', \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
                static::TO_ADD    => [
                    ['product.details.page.info.buttons-added.cart-buttons', 400, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ['product.details.quicklook.info.buttons-added.cart-buttons', 400, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ['product.details.page.info.buttons.cart-buttons', 300, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ['product.details.quicklook.info.buttons.cart-buttons', 300, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ];
            ...
            $templates['modules/CDev/Paypal/item_list/product/parts/express_checkout.twig'] = [
                ...
                static::TO_ADD    => [
                    ['itemsList.product.list.customer.info.bcontainer', 999, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ];
        }
    ...
    protected static function moveClassesInLists()
    {
        $classes_list = [
            ...
            'XLite\View\TopCategories' => [
                static::TO_ADD => [
                    ['catalog.top.menu', 5, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ['welcome.menu.banners.block', 5, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ],
            ...
            'XLite\View\BannerRotation\BannerRotation' => [
                ...
                static::TO_ADD => [
                    ['welcome.banner.rotator.container', 1, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ['welcome.menu.banners.block', 20, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
            ...
            'XLite\View\Category' => [
                static::TO_ADD => [
                    ['welcome.text.block', 350, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ],

            'XLite\View\Subcategories' => [
                static::TO_ADD => [
                    ['welcome.subcat', 100, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ],
        ];
        ...
        if (static::isModuleEnabled('CDev\Bestsellers')) {
            $classes_list['XLite\Module\CDev\Bestsellers\View\Bestsellers'] = [
                static::TO_ADD => [
                    ['catalog.top.menu', 200, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ['type3.center.bottom', 100, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
        ...
        if (static::isModuleEnabled('CDev\Sale')) {
            $classes_list['XLite\Module\CDev\Sale\View\SaleBlock'] = [
                static::TO_ADD => [
                    ['tab_sale', 100, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ['welcome.sale.block', 100, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ];
        }
        ...
        if (static::isModuleEnabled('CDev\ProductAdvisor')
            ...
            $classes_list['XLite\Module\CDev\ProductAdvisor\View\NewArrivals'] = [
                static::TO_ADD => [
                    ['tab_new_arrivals', 100, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ['welcome.na.block', 100, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ];

            $classes_list['XLite\Module\CDev\ProductAdvisor\View\ComingSoon'] = [
                static::TO_ADD => [
                    ['welcome.cs.block', 100, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ];

            $classes_list['XLite\Module\CDev\ProductAdvisor\View\RecentlyViewed'] = [
                static::TO_ADD => [
                    ['welcome.recently.block', 100, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ];
        ...
        if (static::isModuleEnabled('CDev\FeaturedProducts')) {
            $classes_list['XLite\Module\CDev\FeaturedProducts\View\Customer\FeaturedProducts'] = [
                static::TO_ADD => [
                    ['tab_featured', 100, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ['welcome.favorite.block', 100, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ];
        }
        ...
        if (static::isModuleEnabled('XC\News')) {
            $classes_list['XLite\Module\XC\News\View\TopNewsSideBar'] = [
                static::TO_DELETE => [
                    ['sidebar.single', \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ['sidebar.first', \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
                static::TO_ADD => [
                    ['footer.textinfo.block', 200, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ];
        }
        ...
        if (static::isModuleEnabled('XC\NewsletterSubscriptions')) {
            $classes_list['XLite\Module\XC\NewsletterSubscriptions\View\SubscribeBlock'] = [
                ...
                static::TO_ADD => [
                    ['welcome.subscribe.info', 10, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ];
        }
        ...
        if (static::isModuleEnabled('XC\ProductComparison')) {
            ...
            $classes_list['XLite\Module\XC\ProductComparison\View\AddToCompare\Products'] = [
                ...
                static::TO_ADD => [
                    ['itemsList.product.grid.customer.info.bcontainer', 200, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                    ['itemsList.product.list.customer.info.bcontainer', 200, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
        ...
        if (static::isModuleEnabled('XC\Upselling')) {
            $classes_list['XLite\Module\XC\Upselling\View\ItemsList\UpsellingProducts'] = [
                ...
                static::TO_ADD => [
                    ['product.details.page.related', 10, \XLite\Model\ViewList::INTERFACE_CUSTOMER],
                ],
            ];
        }
