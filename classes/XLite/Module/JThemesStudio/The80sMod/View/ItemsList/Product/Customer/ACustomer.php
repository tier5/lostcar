...
namespace XLite\Module\JThemesStudio\The80sMod\View\ItemsList\Product\Customer;
...
abstract class ACustomer extends \XLite\View\ItemsList\Product\Customer\ACustomer implements \XLite\Base\IDecorator
{
    ...
    public function getJSFiles()
    {
        ...
        $list[] = 'modules/JThemesStudio/The80sMod/items_list/product/products_list.js';
    ...
    public static function getIconSizes()
    {
        ...
        $result = parent::getIconSizes();

        $result[static::WIDGET_TYPE_CENTER . '.' . static::DISPLAY_MODE_STHUMB] = \XLite\Logic\ImageResize\Generator::getImageSizes($model, 'SBSmallThumbnail');
